...
| `14-vbox-installer-missing-dependencies.webp` | VirtualBox installer — Missing Dependencies warning dialog |
...
| `28-wkstn01-winrm-firewall-public-network-error.webp` | wkstn01: WinRM fails — network is Public, firewall blocks it |
...
| `36-wkstn01-set-netipaddress-ethernet2-not-found.webp` | wkstn01: `Set-NetIPAddress` — Ethernet 2 adapter not found |
...
| `42-vbox-wkstn01-adapter2-host-only-added.webp` | VirtualBox wkstn01 Settings Expert — Adapter 2 Host-Only attached |
| `43-wkstn01-only-ethernet-adapter2-not-yet-visible.webp` | wkstn01: Admin PS — only "Ethernet", Adapter 2 not yet showing in OS |
...
| `46-wkstn01-ip-object-already-exists.webp` | wkstn01: Admin PS — "The object already exists" error |
...
| File | What it shows |
|---|---|
| `67-ansible-promote-dc01-first-attempt-unreachable.webp` | WSL2: `01-promote-dc01.yml` — dc01 UNREACHABLE on first run |
...
| `70-ansible-promote-unsupported-module-params.webp` | WSL2: Promote fails — "Unsupported parameters for microsoft.ad.domain module" |
...
| `79-wazuh-mitre-eventid-4769-no-results.webp` | Wazuh MITRE ATT&CK — EventID 4769 filter, no results (time range too narrow) |
...
| `82-wazuh-mitre-eventid-4672-no-results.webp` | Wazuh MITRE ATT&CK — EventID 4672 filter, no results |
| `83-wazuh-mitre-eventid-4672-no-results-2.webp` | Wazuh MITRE ATT&CK — EventID 4672, no results (different column view) |
| `84-wazuh-mitre-eventid-4672-no-results-dashboard.webp` | Wazuh MITRE ATT&CK Dashboard — EventID 4672, no results for time range |
| `85-wazuh-mitre-47-hits-t1078-logon-events.webp` | Wazuh MITRE ATT&CK — 47 hits, T1078 Windows logon success events from DC01 |
| `86-wazuh-mitre-dc01-logon-type3-events.webp` | Wazuh MITRE ATT&CK — DC01 LogonType:3 events, 47 hits, page loading |
